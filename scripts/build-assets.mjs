...
const assets = ['index.html', 'styles.css', 'app.js', 'storage.js', 'manifest.webmanifest', 'icon.svg', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png', 'sw.js', 'firebase-messaging-sw.js'];
