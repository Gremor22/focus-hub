...
const assets = ['index.html', 'styles.css', 'app.js', 'state.js', 'render.js', 'actions.js', 'storage.js', 'projects.js', 'daily.js', 'journal.js', 'account.js', 'manifest.webmanifest', 'icon.svg', 'apple-touch-icon.png', 'icon-192.png', 'icon-512.png', 'sw.js', 'firebase-messaging-sw.js'];
